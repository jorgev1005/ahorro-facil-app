...
const REMOTE_DIR = '/var/www/ahorro_facil'; // Correct root

const conn = new Client();

console.log('🚀 PUSHING DEBUG PUBLIC ROUTE TO CORRECT DIR...');
        ...
        try {
            ...
            return res.status(401).json({ 
                ...
                debug: {
                    ...
                    secretStart: process.env.JWT_SECRET ? process.env.JWT_SECRET.substring(0, 5) : 'UNDEFINED'
                }
            });
        }
...
`;
    ...
    // NOTE: Writing to src/routes/public.js directly, NOT server/src/routes/public.js
    const cmd = `
    cd ${REMOTE_DIR}
    ...
    conn.exec(cmd, (err, stream) => {
        ...
        stream.on('close', (code, signal) => {
            conn.end();
            console.log('✅ PUSH TO CORRECT DIR DONE');
